...
var donationSumBox = document.getElementById("donationSummary");

donationSumBox.innerHTML = summaryTable;
...
donorTable += "<tr>";
donorTable += "<th>Donation</th><th>Donor IDidn't</th>";
donorTable += "<th>Date</th><th>Copy</th><th>Address</th>";
donorTable += "<th>This</th><th>E-mail</th>";
donorTable += "</tr>";
...
var donationTableBox = document.getElementById("donorTable");

donationTableBox.innerHTML = donorTable;
